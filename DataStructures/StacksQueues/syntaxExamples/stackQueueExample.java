...
public class stackQueueExample {
    public static void main(String[] args) {
        ...
        // Enqueue: Using add() and offer() methods
        queue1.add(1);
        queue1.offer(2);
        queue1.offer(3);
        ...
        // Dequeue: using remove() / poll() methods
        System.out.println(queue1.remove());  // Remove the last element of the queue
        System.out.println(queue1.poll());    // Remove the last element of the queue
        ...
        // Peek: using element() and peek() method
        System.out.println(queue1);
        System.out.println(queue1.element()); // Peek: get the value of the first element in the queue.
        System.out.println(queue1.peek());    // Peek: get the value of the first element in the queue.
        System.out.println(queue1);
