...
"""
"""
Idea: We simply run Union-Find three times:
1) first on Type1
2) then on Type2 and Type3 simultaneously
Increment ans whenever we find redundant edges.
Remember to check if the graph is fully connected at the end.
